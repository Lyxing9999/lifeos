      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                _SectionIcon(icon: AppIcons.finance, color: AppColors.sky),
                const SizedBox(width: AppSpacing.md),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
    ...
    return Card(
      child: Padding(
        ...
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _SectionIcon(icon: AppIcons.spending, color: color),
            const SizedBox(width: AppSpacing.md),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                _SectionIcon(
                  icon: log.processed ? AppIcons.success : AppIcons.error,
