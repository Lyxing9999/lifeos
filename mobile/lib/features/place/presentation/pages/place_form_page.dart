              ...
              Wrap(
                ...
                children: [
                  AppButton.secondary(
                    ...
                    icon: _showMapPicker ? AppIcons.chevronUp : AppIcons.map,
                    label: _showMapPicker ? 'Hide map' : 'Choose on map',
                  ),
                  AppButton.secondary(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  AppButton.ghost(
                    onPressed: () {
                      HapticFeedback.selectionClick();
                      setState(() => _showRadiusSlider = !_showRadiusSlider);
                    },
                    icon: _showRadiusSlider
                        ? AppIcons.chevronUp
                        : AppIcons.radius,
                    label: _showRadiusSlider ? 'Hide fine tune' : 'Fine tune',
                  ),
                ],
              ),
              if (_showRadiusSlider)
                Row(
                  children: [
                    Text('10 m', style: AppTextStyles.statLabel(context)),
                    Expanded(
                      child: Slider(
                    ...
                    Text('1 km', style: AppTextStyles.statLabel(context)),
                  ],
                ),
            ],
          ),
          ...
          child: Column(
            ...
            children: [
              ...
              if (_showMoreOptions) ...[
                ...
                _SwitchTile(
                  title: 'Active place',
                  subtitle: 'Inactive places are kept but ignored for matching',
                  value: _active,
                  onChanged: (v) {
                    HapticFeedback.selectionClick();
                    setState(() => _active = v);
