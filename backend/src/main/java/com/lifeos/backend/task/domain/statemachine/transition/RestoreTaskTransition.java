...
@Component
public class RestoreTaskTransition implements TaskTransition {

    @Override
    public boolean supports(TaskTransitionType transitionType) {
        return transitionType == TaskTransitionType.RESTORE;
    }
    ...
    public TaskTransitionResult apply(
        ...
        return TaskTransitionResult.changed(
                ...
                MutationType.INSTANCE_RESTORED,
                fromStatus,
                toStatus,
                command.safeActor(),
                command.safeReason()
