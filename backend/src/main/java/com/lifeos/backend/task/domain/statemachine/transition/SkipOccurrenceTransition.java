...
@Component
public class SkipOccurrenceTransition implements TaskTransition {

    @Override
    public boolean supports(TaskTransitionType transitionType) {
        return transitionType == TaskTransitionType.SKIP_OCCURRENCE;
    }
    ...
    public TaskTransitionResult apply(
        ...
        instance.setSkippedAt(context.now());
